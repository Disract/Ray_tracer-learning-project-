...
int main()
{
	...
	auto material_right = make_shared<metal>(color(0.4,0.4,0.4));

	auto material_mine = make_shared<metal>(color(0.1,0.3,0.5));


	world.add(make_shared<sphere>(point3(1, -100.5, -1), 100,material_ground));
	world.add(make_shared<sphere>(point3(0, 0, -2.0), 0.5,material_center));
